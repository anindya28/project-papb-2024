...
public class tambah_rekam extends AppCompatActivity {
    ...
    private ImageView ivBackTambah;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBackTambah = findViewById(R.id.ivBackTambah);

        ivBackTambah.setOnClickListener(view -> {
        ...
        btSemuaRiwayat.setOnClickListener(view -> {
            Intent intent = new Intent(tambah_rekam.this, SemuaRiwayat.class);
    ...
    private void deleteRekamMedis(RekamMedis rekamMedis, int position) {
        ...
        new Thread(() -> {
            ...
            // Update RecyclerView setelah penghapusan
            runOnUiThread(() -> {
                koleksi.remove(position);
                koleksiAdapter.notifyItemRemoved(position);
            });
        }).start();
    }
