...
public class KoleksiAdapter extends RecyclerView.Adapter {
    ...
    public  interface onDeleteClickListener{
        void onDeletedClicked (RekamMedis rekamMedis, int position);
    }

    public KoleksiAdapter(Context ctx, List<RekamMedis> Koleksi, onDeleteClickListener delete) {
        this.ctx = ctx;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        vh.ivDelete.setOnClickListener(view -> {
            if (delete != null){
                delete.onDeletedClicked(r, position);
            }
        });
